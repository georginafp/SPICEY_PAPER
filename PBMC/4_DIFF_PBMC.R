...
# Save results
saveRDS(gr_list_atac, "/homes/users/gfuentes/scratch/projects/spicey_paper/PBMC/data/P_DA_ATAC_PBMC.rds")
...
# Save results
saveRDS(gr_list_rna, "/homes/users/gfuentes/scratch/projects/spicey_paper/PBMC/data/P_DA_RNA_PBMC.rds")
