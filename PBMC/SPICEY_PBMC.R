...
atac <- readRDS("/homes/users/gfuentes/scratch/projects/spicey_paper/PBMC/data/DA_ATAC_PBMC.rds")
rna <- readRDS("/homes/users/gfuentes/scratch/projects/spicey_paper/PBMC/data/DA_RNA_PBMC.rds")

## 1.2. Co-accessible links derived from code/RUN_COACC.R
links <- readRDS("/homes/users/gfuentes/scratch/projects/spicey_paper/PBMC/data/PBMC_COACC_LINKS.rds")
...
saveRDS(SPICEY_ANNOTATED_COACC, "/homes/users/gfuentes/scratch/projects/spicey_paper/PBMC/data/PBMC_SPICEY_COACC.rds")


spicey_heatmap(SPICEY_ANNOTATED_COACC$linked,
